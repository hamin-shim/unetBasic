...
resize_info = [int(_) for _ in input("Enter resizing start, end, interval: ").split(',')]
resize_data = [[cut_idx, real_idx] for cut_idx, real_idx in enumerate(range(*resize_info))]
